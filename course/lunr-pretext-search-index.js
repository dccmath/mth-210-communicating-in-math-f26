...
},
{
  ...
  "body": "Display (center) important equations and align signs  This means putting important equations, centered, on their own line. Only center important equations that are key to the proof or its conclusion. Minor or helper equations can be left inline. Every equation should have both a left and right-hand side, but if the left side of the equation does not change, don’t repeat it. For example:  You can find examples of how to do this in the sample Overleaf file. "
},
{
  "id": "wc-symbols",
  "level": "2",
